...
<figure><img src="../../.gitbook/assets/image.png" alt="Select the Replace file button to update an uploaded data table"><figcaption><p>Select the Replace file button to update an uploaded data table</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (1).png" alt="Select the Clear Data Cache button to clear all query caches for the report"><figcaption><p>Select the Clear Data Cache button to clear all query caches for the report</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (2).png" alt="Deleting a data table"><figcaption><p>Deleting a data table</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (3).png" alt="A warning message appears if you attempt to delete a data table that is used in the report"><figcaption><p>A warning message appears if you attempt to delete a data table that is used in the report</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/image (4).png" alt="Downloading data"><figcaption><p>Downloading data</p></figcaption></figure>
