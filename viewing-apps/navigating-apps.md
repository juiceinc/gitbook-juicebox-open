...
![Open the draft or shared version of a report from the home page](<../.gitbook/assets/image (131).png>)
...
Some reports have multiple pages. When they do, page navigation links appear below the Home button in the report header. Click a page name to switch to that page. The current page appears highlighted in the navigation.

**\[Screenshot: A report header showing page navigation links for a multi-page report]**

Depending on how the report is configured, your filter selections may carry forward to the new page, so you can keep your current context as you navigate.
